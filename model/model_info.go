...
type ModelInfo struct {
	...
	Provider     string `json:"provider" gorm:"uniqueIndex:idx_model_info_provider_model"` // 服务商
	Model        string `json:"model" gorm:"uniqueIndex:idx_model_info_provider_model"`    // 模型名
